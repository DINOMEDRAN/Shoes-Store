...
<header>
    ...
    <main>
        <section class="catalog-header">
          <h1>Zapatos para tus salidas</h1>
          <p>Explora y busca los zapatos que sean ideales para tus paseos o salidas importantes.</p>
        </section>
        ...
        <section class="catalog">
          ...
          <a href="CONS Fastbreak Pro Suede Nylon Mid Top.php" class="product">
            ...
            <p class="product-name">CONS Fastbreak Pro Suede</p>
          ...
          <a href="weapomidtop.php" class="product">
            ...
            <p class="product-name">Weapon Mid Top</p>
            <p class="product-price">$100.00</p>
          </a>
