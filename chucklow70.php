    ...
    <header>
		...
		<main>
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Chuck Taylor All Star Low Top/negro/1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Chuck Taylor All Star Low Top/negro/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Chuck Taylor All Star Low Top/negro/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Chuck Taylor All Star Low Top/negro/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Chuck Taylor All Star Low Top/negro/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Chuck Taylor All Star Low Top/negro/6.jpg" alt="imagen-producto" />
                    </div>
                </div>
			...
			<div class="container-info-product">
				<div>
					<h3 class="product-title">Chuck Taylor All Star Low Top</h3> <!-- Título del producto -->
				</div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/Chuck Taylor All Star Low Top/blanco oscuro/1.jpg" alt="Negro" class="color-thumbnail" data-color="blanco oscuro" />
            <img src="img/Chuck Taylor All Star Low Top/negro/1.jpg" alt="Blanco" class="color-thumbnail" data-color="negro" />
            <img src="img/Chuck Taylor All Star Low Top/negro negro/1.jpg" alt="Blancodark" class="color-thumbnail" data-color="negro negro" />
            <img src="img/Chuck Taylor All Star Low Top/rojo/1.jpg" alt="Blancodark" class="color-thumbnail" data-color="rojo" />
          </div>
        </div>
					<div class="form-group">
