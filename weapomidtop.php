    ...
    <header>
		...
		<main>
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Converse Weapon Mid Top/1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/6.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Mid Top/7.jpg" alt="imagen-producto" />
                    </div>
                </div>
			...
			<div class="container-info-product">
				<div>
					<h3 class="product-title">Converse Weapon Mid Top</h3> <!-- Título del producto -->
				</div>
				<div class="container-price">
					<span id="product-price">$100.00</span>
			</div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/Converse Weapon Mid Top/1.jpg" alt="Negro" class="color-thumbnail" data-color="Negro" />
          </div>
        </div>
					<div class="form-group">
