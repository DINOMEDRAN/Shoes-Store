    ...
    <header>
		...
		<main>
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Converse Weapon Leather Low Top/1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Leather Low Top/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Leather Low Top/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Leather Low Top/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Leather Low Top/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/Converse Weapon Leather Low Top/6.jpg" alt="imagen-producto" />
                    </div>
                </div>
			...
			<div class="container-info-product">
				<div>
					<h3 class="product-title">Converse Weapon Leather Low Top</h3> <!-- Título del producto -->
				</div>
				<div class="container-price">
					<span id="product-price">$125.00</span>
			</div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/Converse Weapon Leather Low Top/1.jpg" alt="normal" class="color-thumbnail" data-color="normal" />
          </div>
        </div>
					<div class="form-group">
