            ...
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/6.jpg" alt="imagen-producto" />
                    </div>
                </div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/skatebording/Converse x Awake NY One Star Pro Low Top/1.jpg" alt="Stock" class="color-thumbnail" data-color="Stock" />
          </div>
        </div>
					<div class="form-group">
		...
		></script>
		<script src="Converse x Awake NY One Star Pro Low Top.js">
		</script>
	</body>
</html>