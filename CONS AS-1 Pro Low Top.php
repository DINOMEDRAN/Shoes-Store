            ...
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS AS-1 Pro Low Top/7.jpg" alt="imagen-producto" />
                    </div>
                </div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/skatebording/CONS AS-1 Pro Low Top/1.jpg" alt="Stock" class="color-thumbnail" data-color="Stock" />
          </div>
        </div>
					<div class="form-group">
		...
		></script>
		<script src="CONS AS-1 Pro Low Top.js">
		</script>
	</body>
</html>