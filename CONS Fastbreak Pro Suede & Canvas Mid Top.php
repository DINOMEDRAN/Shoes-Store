            ...
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/6.jpg" alt="imagen-producto" />
                    </div>
                </div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/skatebording/CONS Fastbreak Pro Suede Nylon Mid Top/2.jpg" alt="Stock" class="color-thumbnail" data-color="Stock" />
          </div>
        </div>
					<div class="form-group">
		...
		></script>
		<script src="CONS Fastbreak Pro Suede Nylon Mid Top.js">
		</script>
	</body>
</html>