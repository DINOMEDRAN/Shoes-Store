    ...
    <header>
		...
		<main>
            <div class="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/convers/convers.1.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.2.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.3.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.4.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.5.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.6.jpg" alt="imagen-producto" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/convers/convers.7.jpg" alt="imagen-producto" />
                    </div>
                </div>
			...
			<div class="container-info-product">
				<div>
					<h3 class="product-title">Chuck 70 High Top</h3> <!-- Título del producto -->
				</div>
				<div class="container-price">
					<span id="product-price">$95.00</span>
			</div>
      ...
      <div class="container-details-product">
        <div class="form-group">
          ...
          <div class="color-options">
            <img src="img/convers/convers.1.jpg" alt="Negro" class="color-thumbnail" data-color="Negro" />
            <img src="img/chuck 70 white/1.jpg" alt="Blanco" class="color-thumbnail" data-color="Blanco" />
            <img src="img/chuck 70 white dark/1.jpg" alt="Blancodark" class="color-thumbnail" data-color="Blancodark" />
          </div>
        </div>
					<div class="form-group">
